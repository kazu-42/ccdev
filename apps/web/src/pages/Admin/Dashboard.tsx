...
export function AdminDashboard() {
  const { stats, recentProjects, recentUsers, fetchStats, error } = useAdminStore();
            ...
            {recentUsers.length === 0 ? (
              ...
              <div className="space-y-3">
                {recentUsers.map((user) => (
                  <div key={user.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-dark-hover transition-colors">
            ...
            {recentProjects.length === 0 ? (
              ...
              <div className="space-y-3">
                {recentProjects.map((project) => (
                  <div key={project.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-dark-hover transition-colors">
